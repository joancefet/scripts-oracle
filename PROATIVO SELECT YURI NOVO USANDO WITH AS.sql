...
(
            ...
            FROM   MOV_SAIDA A
            WHERE  A.DTNOTA between '01/06/2016' and sysdate - 1 
                   AND A.TPNOTA = 512
                   AND A.STATUS <> 9
...
PF AS (
            ...
            FROM PDV_FISCAL B 
            WHERE B.TIPO = 'F'  AND B.DATA BETWEEN TO_DATE('&dataini') and sysdate - 1
...
FROM   MOV_SAIDA A
WHERE  A.DTNOTA BETWEEN TO_DATE('&dataini') and sysdate - 1 
AND A.TPNOTA = 512
AND A.STATUS <> 9
AND A.SERIE LIKE '%U%'
